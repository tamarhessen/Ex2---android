...
import com.example.login.facebookdesign.PostDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(7) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Post` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `Creator` TEXT, `PostText` TEXT, `PostLikes` INTEGER NOT NULL, `created` INTEGER, `PostImg` TEXT, `CreatorImg` TEXT, `CreatorUsername` TEXT, `liked` INTEGER NOT NULL, `PeopleLiked` TEXT, `Comments` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c6c5066cf12d9c7d1adc9423aa1e9e15')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsPost.put("PostLikes", new TableInfo.Column("PostLikes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPost.put("created", new TableInfo.Column("created", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsPost.put("CreatorUsername", new TableInfo.Column("CreatorUsername", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPost.put("liked", new TableInfo.Column("liked", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPost.put("PeopleLiked", new TableInfo.Column("PeopleLiked", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "c6c5066cf12d9c7d1adc9423aa1e9e15", "a38780851aa0af96824f39a5853ddabb");
