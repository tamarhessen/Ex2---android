...
public final class CommentPostDB_Impl extends CommentPostDB {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '95ccdfe5fb9cf88fd860ec8127e42391')");
      }
    ...
    }, "95ccdfe5fb9cf88fd860ec8127e42391", "31cc3d1ad12b6898ec45806c9e95e0cf");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "commentPost");
  }
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(CommentPostDao.class, CommentPostDao_CommentPostDB_Impl.getRequiredConverters());
  ...
  public CommentPostDao commentPostDao() {
    if (_commentPostDao != null) {
      ...
      synchronized(this) {
        if(_commentPostDao == null) {
          _commentPostDao = new CommentPostDao_CommentPostDB_Impl(this);
        }
        return _commentPostDao;
      }
    }
